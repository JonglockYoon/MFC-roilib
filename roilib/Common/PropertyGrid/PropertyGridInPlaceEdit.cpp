...
CPropertyGridInPlaceEdit::CPropertyGridInPlaceEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID, std::basic_string<TCHAR> sInitText)
{
...
void CPropertyGridInPlaceEdit::EndEdit()
{
  ...
  if (pOwner)
    pOwner->SendMessage(WM_PG_ENDLABELEDIT, (WPARAM) &str, NULL );
