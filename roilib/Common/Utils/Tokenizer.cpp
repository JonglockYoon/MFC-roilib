...
//       if we find a delimiter or we find end of string return
         if (m_Copy.GetAt(m_nPosition) == m_Delimiter.GetAt(i))
         {
            ...
            int nFields = ::_stscanf ((LPCTSTR)strReturn, _T("%d"), &nReturn);
            return nReturn;
         }
      }
//    copy char
...
//       if we find a delimiter or we find end of string return
         if (m_Copy.GetAt(m_nPosition) == m_Delimiter.GetAt(i))
         {
            ...
            int nFields = ::_stscanf ((LPCTSTR)strReturn, _T("%ld"), &nReturn);
            return nReturn;
         }
      }
//    copy char
...
//       if we find a delimiter or we find end of string return
         if (m_Copy.GetAt(m_nPosition) == m_Delimiter.GetAt(i))
         {
            ...
            int nFields = ::_stscanf ((LPCTSTR)strReturn, _T("%g"), &fReturn);
            return fReturn;
         }
      }
//    copy char
...
//       if we find a delimiter or we find end of string return
         if (m_Copy.GetAt(m_nPosition) == m_Delimiter.GetAt(i))
         {
            ...
            strReturn.Replace(',','.'); // replace comma with dot for german numbers
            int nFields = ::_stscanf ((LPCTSTR)strReturn, _T("%lg"), &fReturn);
            return fReturn;
         }
      }
//    copy char
